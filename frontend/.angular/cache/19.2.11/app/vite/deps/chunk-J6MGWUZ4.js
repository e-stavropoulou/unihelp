...
function consumerMarkDirty(node) {
  ...
  (_a4 = node.consumerMarkedDirty) == null ? void 0 : _a4.call(node, node);
}
...
function consumerIsLive(node) {
  var _a4, _b2;
  return node.consumerIsAlwaysLive || ((_b2 = (_a4 = node == null ? void 0 : node.liveConsumerNode) == null ? void 0 : _a4.length) != null ? _b2 : 0) > 0;
}
function assertConsumerNode(node) {
  var _a4, _b2, _c2;
  (_a4 = node.producerNode) != null ? _a4 : node.producerNode = [];
  (_b2 = node.producerIndexOfThis) != null ? _b2 : node.producerIndexOfThis = [];
  (_c2 = node.producerLastReadVersion) != null ? _c2 : node.producerLastReadVersion = [];
}
function assertProducerNode(node) {
  var _a4, _b2;
  (_a4 = node.liveConsumerNode) != null ? _a4 : node.liveConsumerNode = [];
...
var ActionResolver = class {
  ...
  getParentNode(element) {
    ...
    if ((parentNode == null ? void 0 : parentNode.nodeName) === "#document-fragment") {
      return (_a4 = parentNode == null ? void 0 : parentNode.host) != null ? _a4 : null;
    }
    return parentNode;
  }
  /**
...
var Dispatcher = class {
  ...
  dispatch(eventInfo) {
    ...
    (_a4 = this.actionResolver) == null ? void 0 : _a4.resolveEventType(eventInfo);
    (_b2 = this.actionResolver) == null ? void 0 : _b2.resolveAction(eventInfo);
...
function prepareEventForDispatch(eventInfoWrapper) {
  var _a4;
  const event = eventInfoWrapper.getEvent();
  const currentTarget = (_a4 = eventInfoWrapper.getAction()) == null ? void 0 : _a4.element;
  if (currentTarget) {
...
function getQueuedEventInfos(earlyJsactionData) {
  var _a4;
  return (_a4 = earlyJsactionData == null ? void 0 : earlyJsactionData.q) != null ? _a4 : [];
}
...
var _EventContract = class _EventContract {
  ...
  handleEventInfo(eventInfo) {
    ...
    if (!this.dispatcher) {
      ...
      (_a4 = this.queuedEventInfos) == null ? void 0 : _a4.push(eventInfo);
      return;
    }
  ...
  cleanUp() {
    var _a4;
    (_a4 = this.containerManager) == null ? void 0 : _a4.cleanUp();
  ...
  ecrd(dispatcher, restriction) {
    ...
    if ((_a4 = this.queuedEventInfos) == null ? void 0 : _a4.length) {
...
__publicField(_EventContract, "MOUSE_SPECIAL_SUPPORT", MOUSE_SPECIAL_SUPPORT);
var EventContract = _EventContract;
function getAppScopedQueuedEventInfos(appId, dataContainer = window) {
  var _a4;
  return getQueuedEventInfos((_a4 = dataContainer._ejsas) == null ? void 0 : _a4[appId]);
}
...
function createInputSignal(initialValue, options) {
  ...
  function inputValueFn() {
    ...
    if (node.value === REQUIRED_UNSET_VALUE) {
      let message = null;
      if (ngDevMode) {
        const name = (_a4 = options == null ? void 0 : options.debugName) != null ? _a4 : options == null ? void 0 : options.alias;
...
function requiresRefreshOrTraversal(lView) {
  var _a4;
  return !!(lView[FLAGS] & (1024 | 8192) || ((_a4 = lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a4.dirty));
}
function updateAncestorTraversalFlagsOnAttach(lView) {
  var _a4;
  (_a4 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a4.notify(8);
  if (lView[FLAGS] & 64) {
    lView[FLAGS] |= 1024;
  }
...
function markAncestorsForTraversal(lView) {
  var _a4;
  (_a4 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a4.notify(0);
...
function getOrCreateLViewCleanup(view) {
  var _a4;
  return (_a4 = view[CLEANUP]) != null ? _a4 : view[CLEANUP] = [];
}
function getOrCreateTViewCleanup(tView) {
  var _a4;
  return (_a4 = tView.cleanup) != null ? _a4 : tView.cleanup = [];
}
...
function registerPreOrderHooks(directiveIndex, directiveDef, tView) {
  ...
  if (ngOnChanges) {
    ...
    ((_a4 = tView.preOrderHooks) != null ? _a4 : tView.preOrderHooks = []).push(directiveIndex, wrappedOnChanges);
...
function registerPostOrderHooks(tView, tNode) {
  ...
  for (let i = tNode.directiveStart, end = tNode.directiveEnd; i < end; i++) {
    ...
    if (ngAfterContentInit) {
      ((_a4 = tView.contentHooks) != null ? _a4 : tView.contentHooks = []).push(-i, ngAfterContentInit);
    }
...
var _Injector = class _Injector {
  static create(options, parent) {
    ...
    if (Array.isArray(options)) {
      ...
      const name = (_a4 = options.name) != null ? _a4 : "";
      return createInjector({
        name
 ...
 * @nocollapse
 */
__publicField(DestroyRef, "__NG_ELEMENT_ID__", injectDestroyRef);
/**
 * @internal
 * @nocollapse
 */
__publicField(DestroyRef, "__NG_ENV_ID__", (injector) => injector);
...
var EventEmitter_ = class extends Subject {
  ...
  constructor(isAsync = false) {
    ...
    if (isInInjectionContext()) {
      this.destroyRef = (_a4 = inject(DestroyRef, {
        optional: true
      })) != null ? _a4 : void 0;
      this.pendingTasks = (_b2 = inject(PendingTasksInternal, {
        optional: true
      })) != null ? _b2 : void 0;
    }
  }
  ...
  subscribe(observerOrNext, error, complete) {
    ...
    if (observerOrNext && typeof observerOrNext === "object") {
      ...
      nextFn = (_a4 = observer.next) == null ? void 0 : _a4.bind(observer);
  ...
  wrapInTimeout(fn) {
    return (value) => {
      var _a4;
      const taskId = (_a4 = this.pendingTasks) == null ? void 0 : _a4.add();
      setTimeout(() => {
        var _a5;
        try {
          fn(value);
          ...
          if (taskId !== void 0) {
            (_a5 = this.pendingTasks) == null ? void 0 : _a5.remove(taskId);
          }
        }
      });
    };
...
var AsyncStackTaggingZoneSpec = class {
  ...
  constructor(namePrefix, consoleAsyncStackTaggingImpl = console) {
    ...
    this.createTask = (_a4 = consoleAsyncStackTaggingImpl == null ? void 0 : consoleAsyncStackTaggingImpl.createTask) != null ? _a4 : () => null;
  }
...
function hasApplyArgsData(applyArgs, key) {
  ...
  return ((_b2 = (_a4 = applyArgs[0]) == null ? void 0 : _a4.data) == null ? void 0 : _b2[key]) === true;
}
...
var OutputEmitterRef = class {
  ...
  subscribe(callback) {
    ...
    ((_a4 = this.listeners) != null ? _a4 : this.listeners = []).push(callback);
    return {
      unsubscribe: () => {
        var _a5, _b2;
        const idx = (_a5 = this.listeners) == null ? void 0 : _a5.indexOf(callback);
        if (idx !== void 0 && idx !== -1) {
    ...
    try {
      for (const listenerFn of this.listeners) {
        try {
          ...
          (_a4 = this.errorHandler) == null ? void 0 : _a4.handleError(err);
        }
      }
    } finally {
...
function signal(initialValue, options) {
  const signalFn = createSignal(initialValue, options == null ? void 0 : options.equal);
...
var QueryList = class {
  ...
  get changes() {
    var _a4;
    return (_a4 = this._changes) != null ? _a4 : this._changes = new Subject();
  }
  /**
  ...
  setDirty() {
    var _a4;
    this.dirty = true;
    (_a4 = this._onDirty) == null ? void 0 : _a4.call(this);
  }
  /** internal */
  destroy() {
...
var CSP_NONCE = new InjectionToken(ngDevMode ? "CSP nonce" : "", {
  ...
  factory: () => {
    var _a4, _b2;
    return ((_b2 = (_a4 = getDocument().body) == null ? void 0 : _a4.querySelector("[ngCspNonce]")) == null ? void 0 : _b2.getAttribute("ngCspNonce")) || null;
  }
});
...
function performanceMarkFeature(feature) {
  ...
  (_a4 = performance == null ? void 0 : performance.mark) == null ? void 0 : _a4.call(performance, "mark_feature_usage", {
    detail: {
      feature
    }
  });
 ...
 * @nocollapse
 */
__publicField(ViewContext, "__NG_ELEMENT_ID__", injectViewContext);
...
var _AfterRenderManager = class _AfterRenderManager {
  ...
  execute() {
    var _a4;
    (_a4 = this.impl) == null ? void 0 : _a4.execute();
  }
};
/** @nocollapse */
__publicField(
...
var _AfterRenderImpl = class _AfterRenderImpl {
  ...
  register(sequence) {
    ...
    if (view !== void 0) {
      ((_a4 = view[AFTER_RENDER_SEQUENCES_TO_ADD]) != null ? _a4 : view[AFTER_RENDER_SEQUENCES_TO_ADD] = []).push(sequence);
...
var AfterRenderSequence = class {
  ...
  afterRun() {
    ...
    (_a4 = this.snapshot) == null ? void 0 : _a4.dispose();
    this.snapshot = null;
  }
  destroy() {
    var _a4, _b2;
    this.impl.unregister(this);
    (_a4 = this.unregisterOnDestroy) == null ? void 0 : _a4.call(this);
    const scheduled = (_b2 = this.view) == null ? void 0 : _b2[AFTER_RENDER_SEQUENCES_TO_ADD];
    if (scheduled) {
...
function afterRender(callbackOrSpec, options) {
  ...
  !(options == null ? void 0 : options.injector) && assertInInjectionContext(afterRender);
  const injector = (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : inject(Injector);
  if (false) {
...
function afterNextRender(callbackOrSpec, options) {
  var _a4;
  !(options == null ? void 0 : options.injector) && assertInInjectionContext(afterNextRender);
  const injector = (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : inject(Injector);
  if (false) {
    return NOOP_AFTER_RENDER_REF;
  }
...
function afterRenderImpl(callbackOrSpec, injector, options, once) {
  ...
  (_a4 = manager.impl) != null ? _a4 : manager.impl = injector.get(AfterRenderImpl);
  const tracing = injector.get(TracingService, null, {
    optional: true
  });
  const hooks = (_b2 = options == null ? void 0 : options.phase) != null ? _b2 : AfterRenderPhase.MixedReadWrite;
  ...
  const sequence = new AfterRenderSequence(manager.impl, getHooks(callbackOrSpec, hooks), viewContext == null ? void 0 : viewContext.view, once, destroyRef, tracing == null ? void 0 : tracing.snapshot(null));
...
function getMinimumDurationForState(tDetails, currentState) {
  ...
  if (currentState === DeferBlockState.Placeholder) {
    return (_b2 = (_a4 = tDetails.placeholderBlockConfig) == null ? void 0 : _a4[MINIMUM_SLOT]) != null ? _b2 : null;
  } else if (currentState === DeferBlockState.Loading) {
    return (_d = (_c2 = tDetails.loadingBlockConfig) == null ? void 0 : _c2[MINIMUM_SLOT]) != null ? _d : null;
  }
  return null;
}
function getLoadingBlockAfter(tDetails) {
  var _a4, _b2;
  return (_b2 = (_a4 = tDetails.loadingBlockConfig) == null ? void 0 : _a4[LOADING_AFTER_SLOT]) != null ? _b2 : null;
}
...
function trackTriggerForDebugging(tView, tNode, textRepresentation) {
  var _a4, _b2, _c2;
  const tDetails = getTDeferBlockDetails(tView, tNode);
  (_a4 = tDetails.debug) != null ? _a4 : tDetails.debug = {};
...
function getTriggerLView(deferredHostLView, deferredTNode, walkUpTimes) {
  ...
  const triggerLView = (_a4 = deferredContainer[CONTAINER_HEADER_OFFSET]) != null ? _a4 : null;
...
function setJSActionAttributes(nativeElement, eventTypes, parentDeferBlockId = null) {
  ...
  const parts = eventTypes.reduce((prev, curr) => {
    var _a4;
    return ((_a4 = existingAttr == null ? void 0 : existingAttr.indexOf(curr)) != null ? _a4 : -1) === -1 ? prev + curr + ":;" : prev;
  }, "");
...
var sharedStashFunction = (rEl, eventType, listenerFn) => {
  var _a4, _b2;
  const el = rEl;
  const eventListenerMap = (_a4 = el.__jsaction_fns) != null ? _a4 : /* @__PURE__ */ new Map();
...
var sharedMapFunction = (rEl, jsActionMap) => {
  var _a4, _b2;
  const el = rEl;
  let blockName = (_a4 = el.getAttribute(DEFER_BLOCK_SSR_ID_ATTRIBUTE)) != null ? _a4 : "";
...
function invokeListeners(event, currentTarget) {
  var _a4;
  const handlerFns = (_a4 = currentTarget == null ? void 0 : currentTarget.__jsaction_fns) == null ? void 0 : _a4.get(event.type);
...
var _DehydratedBlockRegistry = class _DehydratedBlockRegistry {
  ...
  get(blockId) {
    var _a4;
    return (_a4 = this.registry.get(blockId)) != null ? _a4 : null;
  }
  has(blockId) {
  ...
  cleanup(hydratedBlocks) {
    ...
    if (this.size === 0) {
      (_a4 = this.contract.instance) == null ? void 0 : _a4.cleanUp();
    }
  }
  get size() {
  ...
  invokeTriggerCleanupFns(blockId) {
    var _a4;
    const fns = (_a4 = this.cleanupFns.get(blockId)) != null ? _a4 : [];
    for (let fn of fns) {
      fn();
    }
  ...
  awaitParentBlock(topmostParentBlock, callback) {
    var _a4;
    const parentBlockAwaitCallbacks = (_a4 = this.awaitingCallbacks.get(topmostParentBlock)) != null ? _a4 : [];
...
var DehydratedBlockRegistry = _DehydratedBlockRegistry;
...
function retrieveHydrationInfoImpl(rNode, injector, isRootView2 = false) {
  ...
  const dehydratedView = {
    data,
    firstChild: (_a4 = rNode.firstChild) != null ? _a4 : null
  };
  if (isRootView2) {
...
function getTextNodeContent(node) {
  var _a4;
  return (_a4 = node.textContent) == null ? void 0 : _a4.replace(/\s/gm, "");
}
...
function readHydrationInfo(node) {
  var _a4;
  return (_a4 = node[HYDRATION_INFO_KEY]) != null ? _a4 : null;
}
...
function isRNodeClaimedForHydration(node) {
  var _a4;
  return ((_a4 = readHydrationInfo(node)) == null ? void 0 : _a4.status) === HydrationStatus.Hydrated;
}
function setSegmentHead(hydrationInfo, index, node) {
  var _a4;
  (_a4 = hydrationInfo.segmentHeads) != null ? _a4 : hydrationInfo.segmentHeads = {};
  hydrationInfo.segmentHeads[index] = node;
}
function getSegmentHead(hydrationInfo, index) {
  var _a4, _b2;
  return (_b2 = (_a4 = hydrationInfo.segmentHeads) == null ? void 0 : _a4[index]) != null ? _b2 : null;
}
...
function getNgContainerSize(hydrationInfo, index) {
  ...
  let size = (_b2 = (_a4 = data[ELEMENT_CONTAINERS]) == null ? void 0 : _a4[index]) != null ? _b2 : null;
...
function isSerializedElementContainer(hydrationInfo, index) {
  var _a4;
  return ((_a4 = hydrationInfo.data[ELEMENT_CONTAINERS]) == null ? void 0 : _a4[index]) !== void 0;
}
function getSerializedContainerViews(hydrationInfo, index) {
  var _a4, _b2;
  return (_b2 = (_a4 = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a4[index]) != null ? _b2 : null;
}
function calcSerializedContainerSize(hydrationInfo, index) {
  var _a4, _b2;
  const views = (_a4 = getSerializedContainerViews(hydrationInfo, index)) != null ? _a4 : [];
  let numNodes = 0;
...
function isDisconnectedNode$1(hydrationInfo, index) {
  ...
  return !!((_a4 = initDisconnectedNodes(hydrationInfo)) == null ? void 0 : _a4.has(index));
}
function processTextNodeBeforeSerialization(context, node) {
  ...
  } else if (((_a4 = el.nextSibling) == null ? void 0 : _a4.nodeType) === Node.TEXT_NODE) {
    corruptedTextNodes.set(
      el,
      "ngtns"
...
function getHydrateTimerTrigger(blockData) {
  var _a4, _b2;
  const trigger = (_a4 = blockData[DEFER_HYDRATE_TRIGGERS]) == null ? void 0 : _a4.find((t) => isTimerTrigger(t));
  return (_b2 = trigger == null ? void 0 : trigger.delay) != null ? _b2 : null;
}
function hasHydrateTrigger(blockData, trigger) {
  var _a4, _b2;
  return (_b2 = (_a4 = blockData[DEFER_HYDRATE_TRIGGERS]) == null ? void 0 : _a4.includes(trigger)) != null ? _b2 : false;
}
...
function isSsrContentsIntegrity(node) {
  var _a4;
  return !!node && node.nodeType === Node.COMMENT_NODE && ((_a4 = node.textContent) == null ? void 0 : _a4.trim()) === SSR_CONTENT_INTEGRITY_MARKER;
}
...
function trustedHTMLFromString(html) {
  var _a4;
  return ((_a4 = getPolicy$1()) == null ? void 0 : _a4.createHTML(html)) || html;
}
function trustedScriptURLFromString(url) {
  var _a4;
  return ((_a4 = getPolicy$1()) == null ? void 0 : _a4.createScriptURL(url)) || url;
}
var policy;
function getPolicy() {
  if (policy === void 0) {
...
function trustedHTMLFromStringBypass(html) {
  var _a4;
  return ((_a4 = getPolicy()) == null ? void 0 : _a4.createHTML(html)) || html;
}
function trustedScriptFromStringBypass(script) {
  var _a4;
  return ((_a4 = getPolicy()) == null ? void 0 : _a4.createScript(script)) || script;
}
function trustedScriptURLFromStringBypass(url) {
  var _a4;
  return ((_a4 = getPolicy()) == null ? void 0 : _a4.createScriptURL(url)) || url;
}
...
var DOMParserHelper = class {
  ...
  getInertBodyElement(html) {
    ...
    try {
      ...
      (_a4 = body.firstChild) == null ? void 0 : _a4.remove();
      return body;
    } catch {
      return null;
    }
...
function getTemplateLocationDetails(lView) {
  ...
  const componentClassName = (_a4 = hostComponentDef == null ? void 0 : hostComponentDef.type) == null ? void 0 : _a4.name;
...
function setNgReflectProperties(lView, tView, tNode, publicName, value) {
  ...
  const inputConfig = (_a4 = tNode.inputs) == null ? void 0 : _a4[publicName];
...
function storePropertyBindingMetadata(tData, tNode, propertyName, bindingIndex, ...interpolationParts) {
  ...
  if (tData[bindingIndex] === null) {
    if (!((_a4 = tNode.inputs) == null ? void 0 : _a4[propertyName]) && !((_b2 = tNode.hostDirectiveInputs) == null ? void 0 : _b2[propertyName])) {
...
function setAllInputsForProperty(tNode, tView, lView, publicName, value) {
  var _a4, _b2;
  const inputs = (_a4 = tNode.inputs) == null ? void 0 : _a4[publicName];
...
function renderView(tView, lView, context) {
  ...
  try {
    ...
    (_a4 = lView[QUERIES]) == null ? void 0 : _a4.finishViewCreation(tView);
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context, options) {
  ...
  try {
    ...
    const embeddedLView = createLView(declarationLView, embeddedTView, context, viewFlags, null, templateTNode, null, null, (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : null, (_b2 = options == null ? void 0 : options.embeddedViewInjector) != null ? _b2 : null, (_c2 = options == null ? void 0 : options.dehydratedView) != null ? _c2 : null);
...
function detachViewFromDOM(tView, lView) {
  var _a4;
  (_a4 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a4.notify(9);
...
function getOrBorrowReactiveLViewConsumer(lView) {
  var _a4;
  return (_a4 = lView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a4 : borrowReactiveLViewConsumer(lView);
}
function borrowReactiveLViewConsumer(lView) {
  var _a4;
  const consumer = (_a4 = freeConsumers.pop()) != null ? _a4 : Object.create(REACTIVE_LVIEW_CONSUMER_NODE);
...
function getOrCreateTemporaryConsumer(lView) {
  var _a4;
  const consumer = (_a4 = lView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a4 : Object.create(TEMPORARY_CONSUMER_NODE);
  consumer.lView = lView;
  return consumer;
}
...
function detectChangesInternal(lView, notifyErrorHandler = true, mode = 0) {
  ...
  if (!checkNoChangesMode) {
    (_a4 = rendererFactory.begin) == null ? void 0 : _a4.call(rendererFactory);
  }
  try {
...
function markViewDirty(lView, source) {
  ...
  (_a4 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a4.notify(source);
  while (lView) {
...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  get ssrId() {
    var _a4;
    return ((_a4 = this._declarationTContainer.tView) == null ? void 0 : _a4.ssrId) || null;
  }
...
function describeRNode(rNode, innerContent = "…") {
  ...
  switch (node.nodeType) {
    ...
    case Node.COMMENT_NODE:
      return `<!-- ${shorten((_a4 = node.textContent) != null ? _a4 : "")} -->`;
    default:
...
function isFirstElementInNgContainer(tNode) {
  var _a4;
  return !tNode.prev && ((_a4 = tNode.parent) == null ? void 0 : _a4.type) === 8;
}
...
function locateNextRNode(hydrationInfo, tView, lView, tNode) {
  ...
  if (native === void 0) {
    ...
    if (nodes == null ? void 0 : nodes[noOffsetIndex]) {
      ...
      const previousTNode = (_a4 = tNode.prev) != null ? _a4 : tNode.parent;
...
function gatherDeferBlocksCommentNodes(doc, node) {
  ...
  while (currentNode = commentNodesIterator.nextNode()) {
    ...
    const nghIdx = (_a4 = content == null ? void 0 : content.indexOf(nghPattern)) != null ? _a4 : -1;
    if (nghIdx > -1) {
...
function acceptNode(node) {
  var _a4;
  return ((_a4 = node.textContent) == null ? void 0 : _a4.trimStart().startsWith("ngh=")) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
}
...
function getFirstNativeNodeForI18nNode(lView, node) {
  ...
  if (isTNodeShape(maybeTNode)) {
    ...
    return (_a4 = unwrapRNode(lView[node.index])) != null ? _a4 : null;
  }
}
...
function skipSiblingNodes(state, skip) {
  ...
  for (let i = 0; i < skip; i++) {
    ...
    currentNode = (_a4 = currentNode == null ? void 0 : currentNode.nextSibling) != null ? _a4 : null;
  }
  return currentNode;
}
...
function prepareI18nBlockForHydrationImpl(lView, index, parentTNode, subTemplateIndex) {
  ...
  const disconnectedNodes = (_a4 = initDisconnectedNodes(hydrationInfo)) != null ? _a4 : /* @__PURE__ */ new Set();
  const i18nNodes = (_b2 = hydrationInfo.i18nNodes) != null ? _b2 : hydrationInfo.i18nNodes = /* @__PURE__ */ new Map();
  const caseQueue = (_d = (_c2 = hydrationInfo.data[I18N_DATA]) == null ? void 0 : _c2[index - HEADER_OFFSET]) != null ? _d : [];
  const dehydratedIcuData = (_e = hydrationInfo.dehydratedIcuData) != null ? _e : hydrationInfo.dehydratedIcuData = /* @__PURE__ */ new Map();
  ...
  if (Array.isArray(nodeOrNodes)) {
    ...
    switch (nodeOrNodes.kind) {
      case 0: {
        ...
        setCurrentNode(state, (_a4 = currentNode == null ? void 0 : currentNode.nextSibling) != null ? _a4 : null);
        break;
      }
      case 1: {
        ...
        const currentNode = appendI18nNodeToCollection(context, state, nodeOrNodes);
        setCurrentNode(state, (_d = currentNode == null ? void 0 : currentNode.nextSibling) != null ? _d : null);
        break;
      }
      case 2: {
        ...
        switch (nodeOrNodes.type) {
          case 0: {
            ...
            if (isSerializedElementContainer(hydrationInfo, noOffsetIndex)) {
              ...
              collectI18nNodesFromDom(context, forkHydrationState(state, (_f = (_e = state.currentNode) == null ? void 0 : _e.firstChild) != null ? _f : null), nodeOrNodes.children);
              setCurrentNode(state, (_g = currentNode == null ? void 0 : currentNode.nextSibling) != null ? _g : null);
...
function claimDehydratedIcuCaseImpl(lView, icuIndex, caseIndex) {
  var _a4;
  const dehydratedIcuDataMap = (_a4 = lView[HYDRATION]) == null ? void 0 : _a4.dehydratedIcuData;
...
function removeDehydratedViews(lContainer) {
  var _a4;
  const views = (_a4 = lContainer[DEHYDRATED_VIEWS]) != null ? _a4 : [];
...
function locateDehydratedViewsInContainer(currentRNode, serializedViews) {
  ...
  for (const serializedView of serializedViews) {
    for (let i = 0; i < ((_a4 = serializedView[MULTIPLIER]) != null ? _a4 : 1); i++) {
      const view = {
        data: serializedView,
        firstChild: null
      };
...
var _a;
var ComponentFactoryResolver$1 = (_a = class {
}, __publicField(_a, "NULL", new _NullComponentFactoryResolver()), _a);
...
function resolveHostDirectives(matches) {
  ...
  for (const def of matches) {
    if (def.findHostDirectiveDefs !== null) {
      allDirectiveDefs != null ? allDirectiveDefs : allDirectiveDefs = [];
...
function markAsComponentHost(tView, hostTNode, componentOffset) {
  ...
  ((_a4 = tView.components) != null ? _a4 : tView.components = []).push(hostTNode.index);
}
function initializeDirectives(tView, lView, tNode, directives, exportsMap, hostDirectiveDefs, hostDirectiveRanges) {
  ...
  for (let i = 0; i < directivesLength; i++) {
    ...
    if (!preOrderHooksFound && (lifeCycleHooks.ngOnChanges || lifeCycleHooks.ngOnInit || lifeCycleHooks.ngDoCheck)) {
      ((_a4 = tView.preOrderHooks) != null ? _a4 : tView.preOrderHooks = []).push(tNode.index);
...
function setupSelectorMatchedInputsOrOutputs(mode, tNode, def, directiveIndex) {
  ...
  for (const publicName in aliasMap) {
    if (aliasMap.hasOwnProperty(publicName)) {
      let bindings;
      if (mode === 0) {
        bindings = (_a4 = tNode.inputs) != null ? _a4 : tNode.inputs = {};
      } else {
...
function setupHostDirectiveInputsOrOutputs(mode, tNode, config, directiveIndex) {
  ...
  for (const initialName in aliasMap) {
    if (aliasMap.hasOwnProperty(initialName)) {
      ...
      let bindings;
      if (mode === 0) {
        bindings = (_a4 = tNode.hostDirectiveInputs) != null ? _a4 : tNode.hostDirectiveInputs = {};
      } else {
...
function setupInitialInputs(tNode, directiveIndex, isHostDirective) {
  ...
  isInlineTemplate(tNode)) {
    (_a4 = tNode.initialInputs) != null ? _a4 : tNode.initialInputs = [];
...
function verifyNotAnOrphanComponent(componentDef) {
  var _a4;
  if ((typeof ngJitMode === "undefined" || ngJitMode) && ((_a4 = componentDef.debugInfo) == null ? void 0 : _a4.forbidOrphanRendering)) {
...
var ComponentFactory2 = class extends ComponentFactory$1 {
  ...
  get inputs() {
    var _a4;
    (_a4 = this.cachedInputs) != null ? _a4 : this.cachedInputs = toInputRefArray(this.componentDef.inputs);
    return this.cachedInputs;
  }
  get outputs() {
    var _a4;
    (_a4 = this.cachedOutputs) != null ? _a4 : this.cachedOutputs = toOutputRefArray(this.componentDef.outputs);
  ...
  constructor(componentDef, ngModule) {
    ...
    this.ngContentSelectors = (_a4 = componentDef.ngContentSelectors) != null ? _a4 : [];
...
var ComponentRef2 = class extends ComponentRef$1 {
  ...
  setInput(name, value) {
    ...
    (_a4 = this.previousInputValues) != null ? _a4 : this.previousInputValues = /* @__PURE__ */ new Map();
...
var R3ViewContainerRef = class ViewContainerRef2 extends VE_ViewContainerRef {
  ...
  createComponent(componentFactoryOrType, indexOrOptions, injector, projectableNodes, environmentInjector) {
    ...
    const componentDef = getComponentDef((_a4 = componentFactory.componentType) != null ? _a4 : {});
...
function populateDehydratedViewsInLContainerImpl(lContainer, tNode, hostLView) {
  ...
  const serializedViews = (_a4 = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a4[noOffsetIndex];
...
function createLQuery(tView, lView, flags) {
  ...
  const lQueries = ((_a4 = lView[QUERIES]) != null ? _a4 : lView[QUERIES] = new LQueries_()).queries;
...
function resolveComponentResources(resourceResolver) {
  ...
  componentResourceResolutionQueue.forEach((component, type) => {
    ...
    if (component.styleUrl && ((_a4 = component.styleUrls) == null ? void 0 : _a4.length)) {
...
function ɵɵdefineComponent(componentDefinition) {
  return noSideEffects(() => {
    ...
    const def = __spreadProps(__spreadValues({}, baseDef), {
      ...
      signals: (_a4 = componentDefinition.signals) != null ? _a4 : false,
  ...
  for (const minifiedKey in obj) {
    if (obj.hasOwnProperty(minifiedKey)) {
      ...
      if (Array.isArray(value)) {
        inputFlags = value[0];
        publicName = value[1];
        declaredName = (_a4 = value[2]) != null ? _a4 : publicName;
...
function ɵɵdefinePipe(pipeDef) {
  ...
  return {
    ...
    standalone: (_a4 = pipeDef.standalone) != null ? _a4 : true,
...
function getNgDirectiveDef(directiveDefinition) {
  ...
  return {
    ...
    standalone: (_a4 = directiveDefinition.standalone) != null ? _a4 : true,
...
function initFeatures(definition) {
  var _a4;
  (_a4 = definition.features) == null ? void 0 : _a4.forEach((fn) => fn(definition));
}
...
function locateOrCreateContainerAnchorImpl(tView, lView, tNode, index) {
  ...
  const ssrId = (_b2 = (_a4 = hydrationInfo.data[TEMPLATES]) == null ? void 0 : _a4[index]) != null ? _b2 : null;
...
function renderDeferBlockState(newState, tNode, lContainer, skipTimerScheduling = false) {
  ...
  if (isValidStateChange(currentState, newState) && isValidStateChange((_a4 = lDetails[NEXT_DEFER_BLOCK_STATE]) != null ? _a4 : -1, newState)) {
...
function findMatchingDehydratedViewForDeferBlock(lContainer, lDetails) {
  var _a4, _b2;
  const dehydratedViewIx = (_b2 = (_a4 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a4.findIndex((view) => view.data[DEFER_BLOCK_STATE$1] === lDetails[DEFER_BLOCK_STATE])) != null ? _b2 : -1;
...
function applyDeferBlockState(newState, lDetails, lContainer, tNode, hostLView) {
  ...
  if (stateTmplIndex !== null) {
    ...
    if (dehydratedViewIx > -1) {
      (_a4 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a4.splice(dehydratedViewIx, 1);
    }
...
function getAsyncClassMetadataFn(type) {
  ...
  return (_a4 = componentClass[ASYNC_COMPONENT_METADATA_FN]) != null ? _a4 : null;
}
...
__publicField(_Console, "ɵprov", ɵɵdefineInjectable({
  token: _Console,
...
function getDeferBlocks(node) {
  var _a4;
  const results = [];
  const lView = (_a4 = getLContext(node)) == null ? void 0 : _a4.lView;
  if (lView) {
  ...
  for (const details of blocks) {
    ...
    const data = {
      ...
      loadingBlock: {
        ...
        minimumTime: (_b2 = (_a4 = tDetails.loadingBlockConfig) == null ? void 0 : _a4[MINIMUM_SLOT]) != null ? _b2 : null,
        afterTime: (_d = (_c2 = tDetails.loadingBlockConfig) == null ? void 0 : _c2[LOADING_AFTER_SLOT]) != null ? _d : null
      },
      placeholderBlock: {
        exists: tDetails.placeholderTmplIndex !== null,
        minimumTime: (_f = (_e = tDetails.placeholderBlockConfig) == null ? void 0 : _e[MINIMUM_SLOT]) != null ? _f : null
      },
      triggers: ((_g = tDetails.debug) == null ? void 0 : _g.triggers) ? Array.from(tDetails.debug.triggers).sort() : [],
      rootNodes
    };
    results.push(data);
    if (renderedLView !== null) {
...
function getDependenciesForTokenInInjector(token, injector) {
  ...
  if (!(injector instanceof NodeInjector)) {
    return (_c2 = (_b2 = (_a4 = resolverToTokenToDependencies.get(injector)) == null ? void 0 : _a4.get) == null ? void 0 : _b2.call(_a4, token)) != null ? _c2 : [];
  }
  const lView = getNodeInjectorLView(injector);
  ...
  return dependencies.filter((dependency) => {
    var _a5;
    const dependencyNode = (_a5 = dependency.injectedIn) == null ? void 0 : _a5.tNode;
...
function getNodeInjectorProviders(injector) {
  ...
  return (_a4 = resolverToProviders.get(diResolver)) != null ? _a4 : [];
}
    ...
    if (!visitedContainers.has(container)) {
      for (const prov of providerToPath.keys()) {
        ...
        deepForEach(containerDef.imports, (moduleImport) => {
          ...
          if (isNextStepInPath) {
            (_a4 = providerToPath.get(prov)) == null ? void 0 : _a4.unshift(container);
          }
        });
      }
    }
...
function getEnvironmentInjectorProviders(injector) {
  var _a4, _b2;
  const providerRecordsWithoutImportPaths = (_a4 = getFrameworkDIDebugData().resolverToProviders.get(injector)) != null ? _a4 : [];
...
function getInjectorMetadata(injector) {
  ...
  if (injector instanceof R3Injector) {
    return {
      type: "environment",
      source: (_a4 = injector.source) != null ? _a4 : null
    };
  }
...
function getInjectorParent(injector) {
  ...
  if (hasParentInjector(parentLocation)) {
    ...
    const injectorParent = (_a4 = chainedInjector.injector) == null ? void 0 : _a4.parent;
...
function getNodesAndEdgesFromSignalMap(signalMap) {
  ...
  for (const [consumer, producers] of signalMap.entries()) {
    ...
    if (isComputedNode(consumer) || isSignalNode(consumer)) {
      ...
      debugSignalGraphNodes.push({
        label: (_e = consumer.debugName) != null ? _e : (_d = (_c2 = (_b2 = (_a4 = consumer.lView) == null ? void 0 : _a4[HOST]) == null ? void 0 : _b2.tagName) == null ? void 0 : _c2.toLowerCase) == null ? void 0 : _d.call(_c2),
        kind: consumer.kind
      });
...
function extractEffectsFromInjector(injector) {
  ...
  const effects = (_a4 = resolverToEffects.get(diResolver)) != null ? _a4 : [];
...
function extractSignalNodesAndEdgesFromRoots(nodes, signalDependenciesMap = /* @__PURE__ */ new Map()) {
  ...
  for (const node of nodes) {
    ...
    const producerNodes = (_a4 = node.producerNode) != null ? _a4 : [];
...
function publishUtil(name, fn) {
  ...
  if (typeof COMPILED === "undefined" || !COMPILED) {
    ...
    (_a4 = w[GLOBAL_PUBLISH_EXPANDO_KEY]) != null ? _a4 : w[GLOBAL_PUBLISH_EXPANDO_KEY] = {};
...
__publicField(_Testability, "ɵprov", ɵɵdefineInjectable({
  token: _Testability,
...
var _TestabilityRegistry = class _TestabilityRegistry {
  ...
  findTestabilityInTree(elem, findInAncestors = true) {
    var _a4;
    return (_a4 = _testabilityGetter == null ? void 0 : _testabilityGetter.findTestabilityInTree(this, elem, findInAncestors)) != null ? _a4 : null;
  }
};
...
__publicField(_TestabilityRegistry, "ɵprov", ɵɵdefineInjectable({
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  ...
  appInits = (_a2 = inject(APP_INITIALIZER, {
    optional: true
  })) != null ? _a2 : [];
...
__publicField(_ApplicationInitStatus, "ɵprov", ɵɵdefineInjectable({
...
var _ApplicationRef = class _ApplicationRef {
  ...
  tickImpl = () => {
    ...
    try {
      ...
      (_a4 = this.tracingSnapshot) == null ? void 0 : _a4.dispose();
  ...
  synchronizeOnce() {
    ...
    if (this.dirtyFlags & 7) {
      ...
      (_b2 = (_a4 = this._rendererFactory) == null ? void 0 : _a4.begin) == null ? void 0 : _b2.call(_a4);
      (_d = (_c2 = this._rendererFactory) == null ? void 0 : _c2.end) == null ? void 0 : _d.call(_c2);
    }
...
__publicField(_ApplicationRef, "ɵprov", ɵɵdefineInjectable({
...
function triggerResourceLoading(tDetails, lView, tNode) {
  ...
  const tView = lView[TVIEW];
  if (tDetails.loadingState !== DeferDependenciesLoadingState.NOT_STARTED) {
    return (_a4 = tDetails.loadingPromise) != null ? _a4 : Promise.resolve();
  }
  const lDetails = getLDeferBlockDetails(lView, tNode);
...
function triggerHydrationForBlockQueue(injector, hydrationQueue, replayQueuedEventsFn) {
  return __async(this, null, function* () {
    ...
    yield (_a4 = blocksBeingHydrated.get(lastBlockName)) == null ? void 0 : _a4.promise;
...
function cleanupRemainingHydrationQueue(hydrationQueue, dehydratedBlockRegistry) {
  ...
  for (const dehydratedBlockId in hydrationQueue) {
    (_a4 = blocksBeingHydrated.get(dehydratedBlockId)) == null ? void 0 : _a4.reject();
  }
...
function getHydrateTriggers(tView, tNode) {
  var _a4;
  const tDetails = getTDeferBlockDetails(tView, tNode);
  return (_a4 = tDetails.hydrateTriggers) != null ? _a4 : tDetails.hydrateTriggers = /* @__PURE__ */ new Map();
}
...
function ɵɵdefer(index, primaryTmplIndex, dependencyResolverFn, loadingTmplIndex, placeholderTmplIndex, errorTmplIndex, loadingConfigIndex, placeholderConfigIndex, enableTimerScheduling, flags) {
  ...
  if (((_a4 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a4.length) > 0) {
...
var LiveCollectionLContainerImpl = class extends LiveCollection {
  ...
  */
  ...
  create(index, value) {
    ...
    (_a4 = this.operationsCounter) == null ? void 0 : _a4.recordCreate();
    return embeddedLView;
  }
  destroy(lView) {
    var _a4;
    destroyLView(lView[TVIEW], lView);
    (_a4 = this.operationsCounter) == null ? void 0 : _a4.recordDestroy();
  }
  updateValue(index, value) {
  ...
  reset() {
    ...
    (_a4 = this.operationsCounter) == null ? void 0 : _a4.reset();
  }
  updateIndexes() {
...
function ɵɵrepeater(collection) {
  ...
  try {
    ...
    if (ngDevMode && metadata.trackByFn === ɵɵrepeaterTrackByIdentity && ((_a4 = liveCollection.operationsCounter) == null ? void 0 : _a4.wasReCreated(liveCollection.length)) && isViewExpensiveToRecreate(getExistingLViewFromLContainer(lContainer, 0))) {
...
function listenerInternal(tView, lView, renderer, tNode, eventName, listenerFn, eventTargetResolver) {
  ...
  if (tNode.type & 3 || eventTargetResolver) {
    ...
    if (existingListener !== null) {
      ...
      stashEventListener == null ? void 0 : stashEventListener(target, eventName, listenerFn);
  ...
  if (processOutputs) {
    const outputConfig = (_a4 = tNode.outputs) == null ? void 0 : _a4[eventName];
...
function ɵɵpipe(index, pipeName) {
  ...
  if (tView.firstCreatePass) {
    ...
    if (pipeDef.onDestroy) {
      ((_a4 = tView.destroyHooks) != null ? _a4 : tView.destroyHooks = []).push(adjustedIndex, pipeDef.onDestroy);
    }
  } else {
...
function clearRendererCache(factory, def) {
  var _a4;
  (_a4 = factory.componentReplaced) == null ? void 0 : _a4.call(factory, def.id);
}
...
function executeWithInvalidateFallback(importMeta, id, callback) {
  ...
  try {
    ...
    if (id !== null && error.message) {
      ...
      (_b2 = (_a4 = importMeta == null ? void 0 : importMeta.hot) == null ? void 0 : _a4.send) == null ? void 0 : _b2.call(_a4, "angular:invalidate", {
        id,
        message: toLog,
        error: true
      });
...
function directiveMetadata(type, metadata) {
  ...
  return {
    ...
    hostDirectives: ((_a4 = metadata.hostDirectives) == null ? void 0 : _a4.map((directive) => typeof directive === "function" ? {
      directive
    } : directive)) || null
  };
}
...
__publicField(_Compiler, "ɵprov", ɵɵdefineInjectable({
  token: _Compiler,
...
function compileNgModuleFactory(injector, options, moduleType) {
  ...
  const compilerProviders = compilerOptions.flatMap((option) => {
    var _a4;
    return (_a4 = option.providers) != null ? _a4 : [];
  });
...
var _NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
  ...
  ngOnDestroy() {
    var _a4;
    (_a4 = this._onMicrotaskEmptySubscription) == null ? void 0 : _a4.unsubscribe();
  }
};
...
__publicField(_NgZoneChangeDetectionScheduler, "ɵprov", ɵɵdefineInjectable({
...
function internalProvideZoneChangeDetection({
  ...
  ngZoneFactory != null ? ngZoneFactory : ngZoneFactory = () => new NgZone(__spreadProps(__spreadValues({}, getNgZoneOptions()), {
    scheduleInRootZone
  }));
  return [
    {
...
function getNgZoneOptions(options) {
  ...
  return {
    ...
    shouldCoalesceEventChangeDetection: (_a4 = options == null ? void 0 : options.eventCoalescing) != null ? _a4 : false,
...
__publicField(_ZoneStablePendingTask, "ɵprov", ɵɵdefineInjectable({
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  ...
  disableScheduling = (_a3 = inject(ZONELESS_SCHEDULER_DISABLED, {
    optional: true
  })) != null ? _a3 : false;
  ...
  angularZoneId = this.zoneIsDefined ? (_b = this.ngZone._inner) == null ? void 0 : _b.get(angularZoneInstanceIdProperty) : null;
  scheduleInRootZone = !this.zonelessEnabled && this.zoneIsDefined && ((_c = inject(SCHEDULE_IN_ROOT_ZONE, {
    optional: true
  })) != null ? _c : false);
  ...
  notify(source) {
    ...
    this.appRef.tracingSnapshot = (_b2 = (_a4 = this.tracing) == null ? void 0 : _a4.snapshot(this.appRef.tracingSnapshot)) != null ? _b2 : null;
  ...
  cleanup() {
    ...
    (_a4 = this.cancelScheduledCallback) == null ? void 0 : _a4.call(this);
...
__publicField(_ChangeDetectionSchedulerImpl, "ɵprov", ɵɵdefineInjectable({
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
  ...
  start() {
    var _a4, _b2;
    if (typeof PerformanceObserver === "undefined" || ((_a4 = this.options) == null ? void 0 : _a4.disableImageSizeWarning) && ((_b2 = this.options) == null ? void 0 : _b2.disableImageLazyLoadWarning)) {
      return;
    }
    ...
    if (win) {
      ...
      const setup = () => {
        ...
        if (doc.readyState === "complete") {
          ...
          (_a5 = this.window) == null ? void 0 : _a5.addEventListener("load", waitToScan, {
            once: true
          });
        }
      };
  ...
  initPerformanceObserver() {
    ...
    const observer = new PerformanceObserver((entryList) => {
      ...
      const imgSrc = (_b2 = (_a4 = lcpElement.element) == null ? void 0 : _a4.src) != null ? _b2 : "";
  ...
  scanImages() {
    ...
    images.forEach((image) => {
      var _a5, _b2;
      if (!((_a5 = this.options) == null ? void 0 : _a5.disableImageSizeWarning)) {
    ...
    if (lcpElementFound && !lcpElementLoadedCorrectly && this.lcpImageUrl && !((_a4 = this.options) == null ? void 0 : _a4.disableImageLazyLoadWarning)) {
...
__publicField(_ImagePerformanceWarning, "ɵprov", ɵɵdefineInjectable({
...
var _PlatformRef = class _PlatformRef {
  ...
  bootstrapModuleFactory(moduleFactory, options) {
    const scheduleInRootZone = options == null ? void 0 : options.scheduleInRootZone;
    const ngZoneFactory = () => getNgZone(options == null ? void 0 : options.ngZone, __spreadProps(__spreadValues({}, getNgZoneOptions({
...
__publicField(_PlatformRef, "ɵprov", ɵɵdefineInjectable({
  token: _PlatformRef,
...
function getPlatform() {
  var _a4;
  return (_a4 = _platformInjector == null ? void 0 : _platformInjector.get(PlatformRef)) != null ? _a4 : null;
}
function destroyPlatform() {
  var _a4;
  (_a4 = getPlatform()) == null ? void 0 : _a4.destroy();
}
...
function provideExperimentalCheckNoChangesForDebug(options) {
  if (typeof ngDevMode === "undefined" || ngDevMode) {
    ...
    return makeEnvironmentProviders([(options == null ? void 0 : options.useNgZoneOnStable) ? {
      provide: NgZone,
...
var DebugElement = class extends DebugNode {
  ...
  get styles() {
    var _a4;
    const element = this.nativeElement;
    return (_a4 = element == null ? void 0 : element.style) != null ? _a4 : {};
  }
  /**
...
__publicField(_ApplicationModule, "ɵmod", ɵɵdefineNgModule({
  type: _ApplicationModule
}));
__publicField(_ApplicationModule, "ɵinj", ɵɵdefineInjector({}));
  ...
  const providers = [{
    ...
    useFactory: () => {
      ...
      if (true) {
        ...
        isEnabled = !!((_a4 = window._ejsas) == null ? void 0 : _a4[appId]);
      }
      if (isEnabled) {
      ...
      useFactory: () => {
        ...
        return () => {
          ...
          appRef.whenStable().then(() => {
            ...
            const jsActionMap = injector.get(JSACTION_BLOCK_ELEMENT_MAP);
            (_a4 = jsActionMap.get(EAGER_CONTENT_LISTENERS_KEY)) == null ? void 0 : _a4.forEach(removeListeners);
...
function invokeRegisteredReplayListeners(injector, event, currentTarget) {
  var _a4;
  const blockName = (_a4 = currentTarget && currentTarget.getAttribute(DEFER_BLOCK_SSR_ID_ATTRIBUTE)) != null ? _a4 : "";
...
function serializeLContainer(lContainer, tNode, lView, parentDeferBlockId, context) {
  ...
  for (let i = CONTAINER_HEADER_OFFSET; i < lContainer.length; i++) {
    ...
    if (views.length > 0 && currentViewAsString === lastViewAsString) {
      ...
      (_a4 = previousView[MULTIPLIER]) != null ? _a4 : previousView[MULTIPLIER] = 1;
...
function appendSerializedNodePath(ngh, tNode, lView, excludedParentNodes) {
  var _a4, _b2, _c2;
  const noOffsetIndex = tNode.index - HEADER_OFFSET;
  (_a4 = ngh[NODES]) != null ? _a4 : ngh[NODES] = {};
  (_c2 = (_b2 = ngh[NODES])[noOffsetIndex]) != null ? _c2 : _b2[noOffsetIndex] = calcPathForNode(tNode, lView, excludedParentNodes);
}
function appendDisconnectedNodeIndex(ngh, tNodeOrNoOffsetIndex) {
  ...
  (_a4 = ngh[DISCONNECTED_NODES]) != null ? _a4 : ngh[DISCONNECTED_NODES] = [];
...
function serializeLView(lView, parentDeferBlockId = null, context) {
  ...
  for (let i = HEADER_OFFSET; i < tView.bindingStartIndex; i++) {
    ...
    if (i18nData) {
      (_a4 = ngh[I18N_DATA]) != null ? _a4 : ngh[I18N_DATA] = {};
    ...
    if (isLContainer(lView[i])) {
      ...
      if (embeddedTView !== null) {
        (_b2 = ngh[TEMPLATES]) != null ? _b2 : ngh[TEMPLATES] = {};
      ...
      (_c2 = ngh[CONTAINERS]) != null ? _c2 : ngh[CONTAINERS] = {};
...
function componentUsesShadowDomEncapsulation(lView) {
  var _a4;
  const instance = lView[CONTEXT];
  return (instance == null ? void 0 : instance.constructor) ? ((_a4 = getComponentDef(instance.constructor)) == null ? void 0 : _a4.encapsulation) === ViewEncapsulation.ShadowDom : false;
}
...
function computed(computation, options) {
  const getter = createComputed(computation, options == null ? void 0 : options.equal);
  if (ngDevMode) {
    getter.toString = () => `[Computed: ${getter()}]`;
    getter[SIGNAL].debugName = options == null ? void 0 : options.debugName;
  }
  return getter;
}
var _MicrotaskEffectScheduler = class _MicrotaskEffectScheduler extends ZoneAwareEffectScheduler {
  pendingTasks = inject(PendingTasksInternal);
  taskId = null;
  schedule(effect2) {
...
var MicrotaskEffectScheduler = _MicrotaskEffectScheduler;
...
function microtaskEffect(effectFn, options) {
  ...
  !(options == null ? void 0 : options.injector) && assertInInjectionContext(effect$1);
  const injector = (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : inject(Injector);
  const destroyRef = (options == null ? void 0 : options.manualCleanup) !== true ? injector.get(DestroyRef) : null;
  const handle = new EffectHandle(injector.get(MicrotaskEffectScheduler), effectFn, typeof Zone === "undefined" ? null : Zone.current, destroyRef, injector, (_b2 = options == null ? void 0 : options.allowSignalWrites) != null ? _b2 : false);
  ...
  if (!cdr || !(cdr._lView[FLAGS] & 8)) {
    ...
    ((_d = (_c2 = cdr._lView)[EFFECTS_TO_SCHEDULE]) != null ? _d : _c2[EFFECTS_TO_SCHEDULE] = []).push(handle.watcher.notify);
  }
  return handle;
}
...
function effect(effectFn, options) {
  ...
  const injector = (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : inject(Injector);
  let destroyRef = (options == null ? void 0 : options.manualCleanup) !== true ? injector.get(DestroyRef) : null;
  let node;
  const viewContext = injector.get(ViewContext, null, {
    optional: true
  });
  const notifier = injector.get(ChangeDetectionScheduler);
  if (viewContext !== null && !(options == null ? void 0 : options.forceRoot)) {
  ...
  if (ngDevMode) {
    node.debugName = (_b2 = options == null ? void 0 : options.debugName) != null ? _b2 : "";
...
var BASE_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, REACTIVE_NODE), {
  ...
  run() {
    ...
    this.hasRun = true;
    const registerCleanupFn = (cleanupFn) => {
      var _a4;
      return ((_a4 = this.cleanupFns) != null ? _a4 : this.cleanupFns = []).push(cleanupFn);
    };
  ...
  maybeCleanup() {
    var _a4;
    if (!((_a4 = this.cleanupFns) == null ? void 0 : _a4.length)) {
      return;
    }
    try {
...
var VIEW_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, BASE_EFFECT_NODE), {
  ...
  destroy() {
    ...
    this.onDestroyFn();
    this.maybeCleanup();
    (_a4 = this.view[EFFECTS]) == null ? void 0 : _a4.delete(this);
  }
}))();
function createViewEffect(view, notifier, fn) {
  ...
  node.fn = fn;
  (_a4 = view[EFFECTS]) != null ? _a4 : view[EFFECTS] = /* @__PURE__ */ new Set();
...
function linkedSignal(optionsOrComputation, options) {
  if (typeof optionsOrComputation === "function") {
    const getter = createLinkedSignal(optionsOrComputation, identityFn, options == null ? void 0 : options.equal);
...
function resource(options) {
  var _a4, _b2;
  (options == null ? void 0 : options.injector) || assertInInjectionContext(resource);
  const request = (_a4 = options.request) != null ? _a4 : () => null;
  return new ResourceImpl(request, getLoader(options), options.defaultValue, options.equal ? wrapEqualityFn(options.equal) : void 0, (_b2 = options.injector) != null ? _b2 : inject(Injector));
}
...
var ResourceImpl = class extends BaseWritableResource {
  ...
  constructor(request, loaderFn, defaultValue, equal, injector) {
    super(
      ...
      computed(() => {
        var _a4, _b2;
        const streamValue = (_b2 = (_a4 = this.state()).stream) == null ? void 0 : _b2.call(_a4);
  ...
  error = computed(() => {
    var _a4, _b2;
    const stream = (_b2 = (_a4 = this.state()).stream) == null ? void 0 : _b2.call(_a4);
  ...
  abortInProgressLoad() {
    ...
    untracked2(() => {
      var _a5;
      return (_a5 = this.pendingController) == null ? void 0 : _a5.abort();
    });
    this.pendingController = void 0;
    (_a4 = this.resolvePendingTask) == null ? void 0 : _a4.call(this);
    ...
    if (lView !== null) {
      for (let i = HEADER_OFFSET; i < lView.length; i++) {
        ...
        if (isComponentHost(tNode)) {
          ...
          const name = ((_a4 = def.debugInfo) == null ? void 0 : _a4.className) || def.type.name;
          if (name) {
            return name;
          } else {
            break;
...
function ɵɵngDeclareClassMetadata(decl) {
  var _a4, _b2;
  setClassMetadata(decl.type, decl.decorators, (_a4 = decl.ctorParameters) != null ? _a4 : null, (_b2 = decl.propDecorators) != null ? _b2 : null);
}
...
var AFTER_RENDER_PHASE_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, SIGNAL_NODE), {
  ...
  phaseFn(previousValue) {
    ...
    try {
      for (const cleanupFn of (_a4 = this.cleanup) != null ? _a4 : EMPTY_CLEANUP_SET) {
        cleanupFn();
      }
    } finally {
      (_b2 = this.cleanup) == null ? void 0 : _b2.clear();
    }
    const args = [];
...
var AfterRenderEffectSequence = class extends AfterRenderSequence {
  ...
  constructor(impl, effectHooks, view, scheduler, destroyRef, snapshot = null) {
    ...
    for (const phase of AFTER_RENDER_PHASES) {
      ...
      node.registerCleanupFn = (fn) => {
        var _a4;
        return ((_a4 = node.cleanup) != null ? _a4 : node.cleanup = /* @__PURE__ */ new Set()).add(fn);
      };
  ...
  destroy() {
    ...
    for (const node of this.nodes) {
      for (const fn of (_a4 = node == null ? void 0 : node.cleanup) != null ? _a4 : EMPTY_CLEANUP_SET) {
        fn();
      }
    }
  }
...
function afterRenderEffect(callbackOrSpec, options) {
  ...
  !(options == null ? void 0 : options.injector) && assertInInjectionContext(afterRenderEffect);
  if (false) {
    return NOOP_AFTER_RENDER_REF;
  }
  const injector = (_a4 = options == null ? void 0 : options.injector) != null ? _a4 : inject(Injector);
  ...
  (_b2 = manager.impl) != null ? _b2 : manager.impl = injector.get(AfterRenderImpl);
  ...
  const sequence = new AfterRenderEffectSequence(manager.impl, [spec.earlyRead, spec.write, spec.mixedReadWrite, spec.read], viewContext == null ? void 0 : viewContext.view, scheduler, injector.get(DestroyRef), tracing == null ? void 0 : tracing.snapshot(null));
  manager.impl.register(sequence);
  return sequence;
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-J6MGWUZ4.js.map
